...
fn gfm_test_403_combined_emphasis_with_citations() {
	...
	let reference_html = "<p><strong>Gomphocarpus (<em>Gomphocarpus \
	                      physocarpus</em>, syn.\n<em>Asclepias \
	                      physocarpa</em>)</strong></p>\n";
	assert_eq!(test_html, reference_html);
}
...
fn gfm_test_426_nested_emphasis_with_unbalanced_delimiters() {
	let test_html = Parser::render("foo******bar*********baz");
	let reference_html = "<p>foo<strong><strong><strong>bar</strong></\
	                      strong></strong>***baz</p>\n";
	assert_eq!(test_html, reference_html);
}
...
fn gfm_test_441_multilevel_nested_emphasis_and_strong_emphasis() {
	let test_html = Parser::render("**foo *bar **baz**\nbim* bop**");
	let reference_html = "<p><strong>foo <em>bar \
	                      <strong>baz</strong>\nbim</em> bop</strong></p>\n";
	assert_eq!(test_html, reference_html);
}
